...
const names=["ab033.01.b64", "ab033.02.b64", "ab033.03.b64", "ab033.04.b64", "ab033.05.b64", "ab033.06.b64"];
...
if(!h.includes('ASHBOUND 0.33.0 HEARTHWARD ALPHA'))throw new Error('Build marker verification failed.');
if(globalThis.crypto?.subtle){const d=await crypto.subtle.digest('SHA-256',new TextEncoder().encode(h)),hex=[...new Uint8Array(d)].map(x=>x.toString(16).padStart(2,'0')).join('');if(hex!=='831f6ddcb964bbf647cff7237b25ad1441ec24863b7d13020462fee2d33af422')throw new Error('Build hash verification failed.')}
